...
func lowerCaseValues(m map[string]string) map[string]string {
	...
	for k, v := range m {
		nm[k] = strings.ToLower(v)
	}
	return nm
}

func lowerCaseSlice(values []string) []string {
...
var COINS_ETHEREUM = lowerCaseValues(map[string]string{
...
var CTokensEthereum = lowerCaseSlice([]string{
...
var YTokensEthereum = lowerCaseSlice([]string{
...
var YCTokensEthereum = lowerCaseSlice([]string{
...
var ATokensEthereum = lowerCaseSlice([]string{
